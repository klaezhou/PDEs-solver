...
def parse_args():
    ...
    # --- basic config ---
    parser.add_argument("--eq", type=str, default="ac", help="Equation name (poisson, ac, etc.)")
    parser.add_argument("--device", type=str, default="cuda:5")
    parser.add_argument("--model", type=str, default="mlp", help="Model architecture (moe_d, mlp,moe_d_w etc.)")
    parser.add_argument("--seed", type=int, default=2026)
    
    # --- sampling ---
    parser.add_argument("--mode_n", type=float, default=5.0) #ac specific
    ...
    parser.add_argument("--w_ic", type=float, default=5.0)
    ...
    parser.add_argument("--gating_hidden_size", type=int, default=10)
    ...
    parser.add_argument("--lr", type=float, default=8e-3) # adam lr
    ...
    # --- plot ---
    parser.add_argument("--save_dir", type=str, default="/home/zhy/Zhou/mixture_of_experts/test_rank/outputs/ac")
    parser.add_argument("--plot_freq", type=dict, default={"adam": 1000, "lbfgs": 50,"proj_adam":500} ) # in error_plot_callback.py for plot error
    parser.add_argument("--loss_freq", type=dict, default={"adam": 5, "lbfgs": 1,"proj_adam":5}) # in checkpoint_callback.py for saving model
    parser.add_argument("--eval_grid_nx", type=int, default=240)
    parser.add_argument("--eval_grid_nt", type=int, default=120)
    
    # --- rank callback ---
    parser.add_argument("--rank_freq", type=dict, default={"adam": 2000, "lbfgs": 30,"proj_adam":2000}) # in rank_callback.py for evaluating rank
    parser.add_argument("--int_grid_n", type=int, default=500)
    parser.add_argument("--int_domain_lowx", type=float, default=0.0)  #time
    parser.add_argument("--int_domain_highx", type=float, default=1.0)
    parser.add_argument("--int_domain_lowy", type=float, default=-1.0)  #x
