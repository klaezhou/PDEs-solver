...
def parse_args():
    ...
    # --- basic config ---
    parser.add_argument("--eq", type=str, default="approximation", help="Equation name (poisson, ac, approximation etc.)")
    ...
    parser.add_argument("--proj_g_upadate_freq", type=int, default=100) # in trainer.py for updating projection g
    ...
    # --- plot ---
    parser.add_argument("--save_dir", type=str, default="/home/zhy/Zhou/mixture_of_experts/test_rank/outputs/approximation")
    ...
    parser.add_argument("--int_grid_n", type=int, default=50)
