...
def parse_args():
    ...
    # --- basic config ---
    parser.add_argument("--eq", type=str, default="navier_stokes", help="Equation name (poisson, ac, etc.)")
    ...
    parser.add_argument("--center_min",type=float,default=0.0)
    parser.add_argument("--center_max",type=float,default=1.0)
    ...
    parser.add_argument("--adam_lr", type=float, default=1e-2) # adam lr
    ...
    # --- plot ---
    parser.add_argument("--save_dir", type=str, default="/home/zhy/Zhou/DLPDEs/dlpdes/outputs/ns")
