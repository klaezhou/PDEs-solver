...
def parse_args():
    ...
    # --- sampling ---
    parser.add_argument("--mode_n", type=float, default=1.0) #ac specific
    ...
    parser.add_argument("--lr", type=float, default=3e-4) # adam lr
    ...
    # --- plot ---
    parser.add_argument("--save_dir", type=str, default="/home/zhy/Zhou/DLPDEs/dlpdes/outputs/ac")
    parser.add_argument("--plot_freq", type=dict, default={"adam": 1000, "lbfgs": 50,"proj_adam":1000} ) # in error_plot_callback.py for plot error
    ...
    parser.add_argument("--int_grid_n", type=int, default=20)
