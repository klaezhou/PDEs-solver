...
def parse_args():
    ...
    # --- basic config ---
    parser.add_argument("--eq", type=str, default="poisson_2", help="Equation name (poisson_2, ac, etc.)")
    parser.add_argument("--device", type=str, default="cuda:4")
    parser.add_argument("--model", type=str, default="mlp_2", help="Model architecture (moe_d, mlp , moe_d_w etc.)")
    ...
    # --- training ---
    parser.add_argument("--lm_epochs", type=int, default=4000)  # lm epochs
    ...
    # --- plot ---
    parser.add_argument("--save_dir", type=str, default="/home/zhy/Zhou/DLPDEs/dlpdes/outputs/possion2")
