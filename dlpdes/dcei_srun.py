...
def parse_args():
    ...
    parser.add_argument("--device", type=str, default="cuda:5") #fb 6
    parser.add_argument("--model", type=str, default="bump_s", help="Model architecture (moe_d, mlp , moe_d_w etc.)")
    ...
    parser.add_argument("--center_steps", type=list, default=[0.01, 0.01])
    ...
    parser.add_argument("--nx", type=int, default=200) #200
    ...
    # --- plot ---
    parser.add_argument("--save_dir", type=str, default="/home/zhy/Zhou/DLPDEs/dlpdes/outputs/dcei_r1")
