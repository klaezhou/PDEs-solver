...
class DCEIEquation(BaseEquation):
    """
    ...
    def f(self, x):
        ...
        f0 = 50 * math.pi**2 * torch.sin(5*math.pi * x1) * torch.sin(5*math.pi * x2)
    ...
    def exact_solution(self, x):
        ...
        u0 = torch.sin(5*torch.pi * x1) * torch.sin(5*torch.pi * x2)

        A = 0.0
        k = 1
        phi = self.bump(x, center=(0.6, 0.4))
